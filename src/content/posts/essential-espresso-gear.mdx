...
Starter espresso machines usually come with dual-wall pressurized filter baskets. While these can help improve shots that use coarser grounds, it's harder to pull a proper extraction.
...
<ProductCard
  ...
  description="Premium portafilter that fits Breville machines.  Other sizes also available!"
  image={{
...
Rounding out the list is a rubberized tamping mat. Tamping mats like [the watchget](https://amzn.to/3lxqfBr) help stabilize the portafilter during tamping and prevents damage to your countertops. 
